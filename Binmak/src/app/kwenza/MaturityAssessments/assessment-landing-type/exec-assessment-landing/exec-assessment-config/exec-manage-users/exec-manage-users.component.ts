...
import { AddCharacteristicComponent } from '../manage-characteristics/add-characteristic/add-characteristic.component';
...
@Component({
  selector: 'app-exec-manage-users',
  templateUrl: './exec-manage-users.component.html',
  styleUrls: ['./exec-manage-users.component.scss']
})
export class ExecManageUsersComponent implements OnInit, AfterViewInit {
