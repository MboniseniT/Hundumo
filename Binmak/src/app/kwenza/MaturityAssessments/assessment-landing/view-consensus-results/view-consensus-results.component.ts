...
export class ViewConsensusResultsComponent implements OnInit {
  ...
  SetCategories(){
    if(!this.DeactivateKPA1()){
      ...
      this.kpidata.push(Math.round(Number(this.progress[0].kpa1Progress)));
    }
    if(!this.DeactivateKPA2()){
      this.ctgrs.push(this.GetAssessment().kpa2);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa2Progress)));
    }
    if(!this.DeactivateKPA3()){
      this.ctgrs.push(this.GetAssessment().kpa3);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa3Progress)));
    }
    if(!this.DeactivateKPA4()){
      this.ctgrs.push(this.GetAssessment().kpa4);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa4Progress)));
    }
    if(!this.DeactivateKPA5()){
      this.ctgrs.push(this.GetAssessment().kpa5);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa5Progress)));
    }
    if(!this.DeactivateKPA6()){
      this.ctgrs.push(this.GetAssessment().kpa6);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa6Progress)));
    }
    if(!this.DeactivateKPA7()){
      this.ctgrs.push(this.GetAssessment().kpa7);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa7Progress)));
    }
    if(!this.DeactivateKPA8()){
      this.ctgrs.push(this.GetAssessment().kpa8);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa8Progress)));
    }
    if(!this.DeactivateKPA9()){
      this.ctgrs.push(this.GetAssessment().kpa9);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa9Progress)));
    }
    if(!this.DeactivateKPA10()){
      this.ctgrs.push(this.GetAssessment().kpa10);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa10Progress)));
    }
    if(!this.DeactivateKPA11()){
      this.ctgrs.push(this.GetAssessment().kpa11);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa11Progress)));
    }
    if(!this.DeactivateKPA12()){
      this.ctgrs.push(this.GetAssessment().kpa12);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa12Progress)));
    }
    if(!this.DeactivateKPA13()){
      this.ctgrs.push(this.GetAssessment().kpa13);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa13Progress)));
    }
    if(!this.DeactivateKPA14()){
      this.ctgrs.push(this.GetAssessment().kpa14);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa14Progress)));
    }
    if(!this.DeactivateKPA15()){
      this.ctgrs.push(this.GetAssessment().kpa15);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa15Progress)));
    }
    if(!this.DeactivateKPA16()){
      this.ctgrs.push(this.GetAssessment().kpa16);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa16Progress)));
    }
    if(!this.DeactivateKPA17()){
      this.ctgrs.push(this.GetAssessment().kpa17);
      this.kpidata.push(Math.round(Number(this.progress[0].kpa17Progress)));
    }
  ...
  calcProgress(){
    this.kpiProgress = Math.round(Number(this.progress[0].assessProgress));
    this.kpiProgressOther = 100 - Math.round(Number(this.progress[0].assessProgress));
  }

  calcTotalScore(){

    setTimeout(() => {
      this.kpiTotalScore = Math.round(Number(this.progress[0].totalScore));
      this.kpiTotalScoreOther = 100 - Math.round(Number(this.progress[0].totalScore));
